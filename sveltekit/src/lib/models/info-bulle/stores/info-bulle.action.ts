...
export const infoBubbleAction = {
	/**
	 * fonction qui défini le left de la div info bulle error
	...
	/**
	 * fonction qui défini le top de la div info bulle error
	 * @param e => evenement de la souris
	 * @param addClient => variable deja init avec l'enum
	 */
	 ...
	 * @param addClient => variable deja init avec l'enum
	 */
	definePositionYInfoBubbleText: (e: MouseEvent, addClient = EInfoBubbleAddClient.Y): void => {
		const y = e.clientY + addClient;
