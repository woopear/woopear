<script lang="ts">
	...
	export let method: IMethod;
</script>

{#if method && 'id' in method}
	<!-- partie public -->
	<BoxRubricSans addStyleDiv="pt-24">
		<section class="md:w-9/12 md:m-auto lg:w-8/12 lg:text-center xl:w-6/12">
	...
	{#if method.steps.length > 0}
		<div
			class="mb-24 px-4 sm:flex sm:flex-col sm:items-center lg:flex-row lg:flex-wrap lg:items-stretch lg:justify-around"
		>
