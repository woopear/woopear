class PresentationConst {
  ...
  static String creationPresentationInputTitle = 'Titre de la présentation *';
  static String creationPresentationInputSubTitle = 'Sous titre de la présentation';
  static String creationPresentationInputEmail = "Email de l'entreprise *";
  static String creationPresentationInputAddress = 'Adresse *';
  static String creationPresentationInputCodePost = 'Code postal *';
  static String creationPresentationInputCity = 'Ville *';
  static String creationPresentationInputPhoneNumber = 'Numéro de téléphone *';
  static String creationPresentationInputInfoSup = 'Information supplémentaire';
  static String creationPresentationPickerNull = "Pas d'image selectionnée";
