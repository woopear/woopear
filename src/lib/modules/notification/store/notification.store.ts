import type { constNotificationType } from './../notification.const';
...
const createNotificationStore = () => {
  ...
  return {
     ...
     */
    async newNotificationUser(type: constNotificationType, libelle:string, uid?: string): Promise<void> {
     ...
     */
    async addNewNotificationUser(type: constNotificationType, libelle: string, uid?: string): Promise<void> {
      let cu: IUser;
